...
import sharingLogo from '../../assets/sharingLogo.png'; // Import the new logo image
...
>
    ...
    <Link to={'/automated'} className="flex items-center">
        Automated
    </Link>
</Typography>
                ...
                <div className="flex items-center justify-between text-blue-gray-900">
                    ...
                    <Link to={'/'}>
                        ...
                        >
                            ...
                            <img
                                className='w-10 h-10'
                                src={sharingLogo} // Updated to use the new logo image
                                alt="Logo"
                            />
                            {/* Logo Text  */}
                            <span>
